...
public class Task3 {
    public static void main(String[] args) {
        ...
        /*
        это ужасный код, задача паттернов - упростить, а не усложнить.
        если я попрошу добавить новый тип напитка и еще добавить 2-3 новых добавки - твой код распухнет до невозможного
        нужно подумать как сделать так, что бы избавиться от условных операторов
        и что бы если будет желание расшить варианты напитков/добавок - изменения были минимальны.
         */
