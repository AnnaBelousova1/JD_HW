...
public class Task8 {
    public static void main(String[] args) {
        ...
        /*
        в задании сказано реализовать метод перемножения матрицы на вектор. нужно вынести логику перемножения в
        отдельный метод. в методе мейн только инициализация и получение результата
         */
